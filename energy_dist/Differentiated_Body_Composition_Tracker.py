...
# Input Files
collision_file = "data/new_day_cr.txt" #collision report
comp_input_file = "data/dbct_input.txt" #initial composition
ejec_file = "data/new_day_ejections.txt" #ejections

# Output Files
comp_output_file = "dbct_output/new_day_output.txt"
